...
rclone sync --ftp-host=$ftp_host --ftp-port=$ftp_port --ftp-user=$ftp_user --ftp-pass=$ftp_pass "$SCRIPT_PATH/localbackup/mirror_destination/" :ftp:$ftp_path/mirror_destination
